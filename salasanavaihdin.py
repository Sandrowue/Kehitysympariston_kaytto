...
# Aseta koodin untittest moden runtest = 1
# testaa kommentoriviltä(terminal)
# dir käskyllä saat katsottua että olet samassa hakemistossa kuin salasanavaihdin.py
# python -m unittest salasanavaihdin
